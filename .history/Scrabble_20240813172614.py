...
WIDTH = 1280
HEIGHT = 720
bigText = pygame.font.Font("helvetica-neue/helveticaneue.otf", 50)
mediumText = pygame.font.Font("helvetica-neue/helveticaneue.otf", 35)
smallText = pygame.font.Font("helvetica-neue/helveticaneue.otf", 20)
