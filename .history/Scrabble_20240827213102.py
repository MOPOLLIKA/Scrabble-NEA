...
def drawRack(xPos: float, yPos: float, index: int, numberOfTiles: int) -> None:
        ...
        for i in range(7 + 1):
                ...
                pygame.draw.line(screen, BLACK, (xPos + i * tileSide, yPos), (xPos + i * tileSide, yPos + rackHeight - 2), width=3)
        # Top horizontal border
        pygame.draw.line(screen, BLACK, (xPos, yPos), (xPos + rackLength, yPos), width=5)
        # Bottom horizontal border
        pygame.draw.line(screen, BLACK, (xPos, yPos + rackHeight - 2.5))
