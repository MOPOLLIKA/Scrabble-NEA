...
def drawFinishTurnButton():
        length = (0.2*WIDTH + 24)/2
        height = 0.1 * HEIGHT
        top = 0.5*HEIGHT - height
        left = (0.5*WIDTH + 0.35*HEIGHT) + (0.5*WIDTH - 0.35*HEIGHT)/2 - 0.1*WIDTH + (0.2*WIDTH + 24)/2

        button = pygame.rect.Rect(left, top, length, height)
        pygame.draw.rect(screen, BROWNDARK, button)

def isPointingAtFinishButton(x: int, y: int):
        length = (0.2*WIDTH + 24)/2
        height = 0.1 * HEIGHT
        top = 0.5*HEIGHT - height
        left = (0.5*WIDTH + 0.35*HEIGHT) + (0.5*WIDTH - 0.35*HEIGHT)/2 - 0.1*WIDTH + (0.2*WIDTH + 24)/2
