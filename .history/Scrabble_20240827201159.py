...
def launchGame() -> None:
        ...
        font = pygame.font.Font("helvetica-neue-5/HelveticaNeueLight.otf", 20)
        text = font.render(f"This is the current width of the screen: {pygame.display.Info().current_w}", True, (255, 255, 255))
