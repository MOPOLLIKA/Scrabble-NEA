...
class Player:
        ...
        def exchangeTiles(self, tilesToRemove: list[str], letterBag: LetterBag) -> None:
                numberOfTiles = len(tilesToRemove)
                if numberOfTiles > letterBag.numberOfLettersRemaining():
                        return None
                for tile in tilesToRemove:
                        letterBag.returnLetter(tile)
                        self.removeLetter(tile)
...
def drawFinishTurnButton() -> None:
        ...
        pygame.draw.rect(screen, BROWNDARK, buttonRect)
...
def drawExchangeTilesButton() -> None:
        ...
        text = mediumText.render("Exchange tiles", True, WHITE)
        textRect = text.get_rect()
        textRect.center = buttonRect.center
        screen.blit(text, textRect)
