...
class Simulation:
        def __init__(self):
                ...
                self.numberOfPlayers: int = 2
                self.players: list[Player] = [Player() for _ in range(self.numberOfPlayers)]

        def startGame(self):
                print("You are playing bumble Scrabble! Please select the number of players:")
                self.numberOfPlayers = int(input("2, 3 or 4 players:"))
