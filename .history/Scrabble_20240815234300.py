...
def drawBoard():
        ...
        for i in range(15):
                pygame.draw.line(screen, (0, 0, 0), (startXPos, startYPos + i * sideLength), (endXPos, startYPos + i * sideLength))
...
while running:
        rect = pygame.draw.rect(screen, (0, 255, 0), [xpos, 100, xpos + 100, 200])
