...
def drawRack(xPos: float, yPos: float, index: int, numberOfTiles: int) -> None:
        ...
        pygame.draw.line(screen, BLACK, (xPos - 1.5, yPos), (xPos + rackLength + 1.5, yPos), width=5)
        # Bottom horizontal border
        pygame.draw.line(screen, BLACK, (xPos - 1.5 , yPos + rackHeight - 2.5), (xPos + rackLength + 1.5, yPos + rackHeight - 2.5), width=5)
