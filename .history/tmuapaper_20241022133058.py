...
questions_paper_1 = [
    ...
    "Question 2: Evaluate the following integral: ∫ (x^2 - 4x + 3) dx from 0 to 2.\n"
    "A. -2/3  B. -2  C. -1  D. 0  E. 1",

    "Question 3: Solve for x in the equation log_2(x+1) + log_2(x-1) = 3.\n"
    "A. 1  B. 3  C. 7  D. 5  E. 8",

    "Question 4: Find the area enclosed between the curve y = sin(x) and the x-axis from x = 0 to x = π.\n"
    "A. 2  B. 1  C. π/2  D. 1.5  E. 4",
...
create_tmua_paper(title_paper_1, instructions_paper_1, questions_paper_1, "mnt/data/TMUA_Mock_Paper_1.pdf")
