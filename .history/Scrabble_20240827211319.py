...
if __name__ == "__main__":
        board = Board()
        board.placeLetter(1, 2, "Y")
        board.placeLetter(2, 2, "E")
        board.placeLetter(3, 2, "N")
        board.placeLetter(4, 2, "R")
        board.placeLetter(5, 2, "O")
        board.placeLetter(6, 2, "T")
        board.placeLetter(7, 2, "T")
        board.placeLetter(8, 2, "A")
        board.printTypes()
