...
bigText = pygame.font.Font("helvetica-neue-5/HelveticaNeueLight.otf", 50)
mediumText = pygame.font.Font("helvetica-neue-5/HelveticaNeueLight.otf", 35)
smallText = pygame.font.Font("helvetica-neue-5/HelveticaNeueLight.otf", 20)
...
def drawBoard():
        sideLength = 0.8 * HEIGHT
        gridLength = sideLength / 15

        startXPos = 0.5 * WIDTH - 0.5 * sideLength
        endXPos = 0.5 * WIDTH + 0.5 * sideLength
        startYPos = 0.1 * HEIGHT
        endYPos = 0.9 * HEIGHT

        # drawing grid
        for i in range(15 + 1):
                pygame.draw.line(screen, (255, 255, 255), (startXPos, startYPos + i * gridLength), (endXPos, startYPos + i * gridLength)) # horizontal
                pygame.draw.line(screen, (255, 255, 255), (startXPos + i * gridLength, startYPos), (startXPos + i * gridLength, endYPos)) # vertical    
