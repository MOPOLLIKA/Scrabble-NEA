...
questions_paper_1 = [
    ...
    "Question 5: If the sequence u_n is defined by u_n = 3u_(n-1) + 2 for n leq 2 and u_1 = 1, what is u_3?\n"
    "A. 13  B. 11  C. 9  D. 7  E. 5",

    "Question 6: Solve the following inequality: (2x + 3) / (x - 1) leq 4.\n"
    "A. x seq -5/2 or x leq 2  B. x seq 5/2 or x leq 2  C. x leq 1  D. x seq -1  E. x < 1",
    ...
    "Question 8: Given that tan(x) = 3/4, find sin(2x).\n"
    ...
    "A. -1  B. 0  C. 1  D. inf  E. Does not exist",

    "Question 17: Find the number of distinct solutions to the equation sin(x) + sin(2x) = 0 in the interval [0, 2pi].\n"
    "A. 2  B. 3  C. 4  D. 5  E. 6",

    "Question 18: The curve y = x^2 is rotated about the x-axis. What is the volume of the solid formed between x = 0 and x = 2?\n"
    "A. 8pi/3  B. 16pi/3  C. 8pi  D. 4pi/3  E. 4pi",
