from Scrabble import findWordsInRow, Board, resizeFolderImages, filenameAdjusted
...
folderPath = "america/TileImages/a.png"
#resizeFolderImages(folderPath)
print(filenameAdjusted(folderPath, "Board"))