...
def indicateTile(tileType: str) -> str:
        ...
        match tileType:
                case "DL":
                        highlighting = Highlighters.OKBLUE
                case "TL":
                        highlighting = Highlighters.OKCYAN
                case "DW":
                        highlighting = Highlighters.OKGREEN
                case "TW":
                        highlighting = Highlighters.OKRED
                case _:
                        indicaiton = ""
        return highlight(tileType, indicaiton)
