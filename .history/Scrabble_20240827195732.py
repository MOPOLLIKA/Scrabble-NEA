...
screen: pygame.Surface = pygame.display.set_mode((screenWidth, screenHeight), pygame.RESIZABLE)
...
def drawBoard() -> None:
        ...
        startXPos: float = 0.5 * screenWidth - 0.5 * sideLength
...
def drawRack(xPos: float, yPos: float, index: int, numberOfTiles: int) -> None:
        ...
        pygame.draw.rect(screen, BROWNLIGHT, [xPos, yPos, length, height])
...
def launchGame() -> None:
        ...
        font = pygame.font.Font("helvetica-neue-5/HelveticaNeueItalic.ttf", 20)
        text = font.render(f"This is the current width of the screen: {pygame.display.Info().current_w}", True, (255, 0, 0))
