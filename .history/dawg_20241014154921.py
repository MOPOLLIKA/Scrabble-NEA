...
class Trie:
    ...
    def findOptimalWord(self, letters: str, possibleWords: list = [], difficulty: int = 6, prohibited: list = []) -> list[str]:
        ...
        for length in range(2, len(letters) + 1):
            ...
            for combination in combinations(letters, length):
                ...
                if maxScore >= difficulty and optimalWord not in prohibited:
                    if optimalWord not in prohibited:
                        return possibleWords[maxScoreIndex]
