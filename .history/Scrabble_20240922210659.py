...
def launchGame() -> None:
        ...
        while running:
                                ...
                                if rackIndex != 0 and playerCurrent.getId() == rackIndex:
                                        ...
                                        if tileIndex <= numberOfLettersAvailable - 1:
                                                ...
                                                if isExchangingTiles:
                                                        ...
                                                        playerCurrent.switchLetterPlacement()
                                                        isHighlighted = True
                                                        if "index" in highlightedTileParams.keys():
                                                                if highlightedTileParams["index"] == tileIndex:
                                                                        isHighlighted = False
                ...
                if True:
                        ...
                        info2 = bigText.render(f"Tile exchanging: {tileExchanging}", True, WHITE)
                        infoRect = info1.get_rect()
                        infoRect.center = (WIDTH/2, 0.95*HEIGHT)
                        screen.blit(info2, infoRect)
