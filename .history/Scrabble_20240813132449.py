...
class Simulation:
        ...
        def startGame(self):
                print()
                print(highlight("You are playing bumble Scrabble! Please select the number of players: ")"You are playing bumble Scrabble! Please select the number of players: ")
