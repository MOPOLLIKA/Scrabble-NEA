...
poll_data = {
    ...
    "How much time would you wait playing against a bot?": ["1-5 sec", "5-15 sec", "15-30 sec", "30-60 sec"],
...
poll_responses = {
    ...
    "How much time would you wait playing against a bot?": [8, 12, 7, 3],
    "Would you like to be able to change the difficulty of the bot?": [22, 8],
    "Would you like to have a player name?": [24, 6],
